...
const About = () => {
  return (
    <div className="container">
      ...
      <div>
        <div className="row">
          <div className="col-12 col-md-12 col-lg-7 mb-4 mb-md-0 d-flex align-items-center">
            <div>
              <p className="mb-3 w-100 w-lg-50 w-md-75 text-success section-text">
                আপনার সকল স্বাস্থ্যসেবা চাহিদা পূরণের জন্য আপনার বিশ্বস্ত
                গন্তব্য,{" "}
                <b style={{ color: "#fbb02e" }}> সাধুখান ফার্মেসিতে </b> আপনাকে
                স্বাগতম। উচ্চমানের ওষুধ এবং স্বাস্থ্যসেবা পণ্য সরবরাহের
                প্রতিশ্রুতি নিয়ে প্রতিষ্ঠিত, আমরা নিষ্ঠা এবং যত্নের সাথে
                সম্প্রদায়ের সেবা করে আসছি।
              </p>

              <p className="mb-3 w-100 w-lg-50 w-md-75 text-success section-text">
                <b style={{ color: "#fbb02e" }}>সাধুখান ফার্মেসিতে</b>, আমরা
                বিশ্বাস করি যে সুস্বাস্থ্য হল একটি সুখী জীবনের ভিত্তি। আমাদের
                লক্ষ্য হল আপনার এবং আপনার প্রিয়জনদের নিরাপদ, কার্যকর এবং
                সাশ্রয়ী মূল্যের ওষুধের অ্যাক্সেস নিশ্চিত করা। আমরা প্রেসক্রিপশন
                ওষুধ, ওভার-দ্য-কাউন্টার ওষুধ, স্বাস্থ্য পরিপূরক এবং ব্যক্তিগত
                যত্ন পণ্যের বিস্তৃত পরিসর মজুত করি, যাতে আপনি এক ছাদের নীচে
                আপনার প্রয়োজনীয় সবকিছু খুঁজে পান।
              </p>
